...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    homeDescription: 'Select purpose → Enter API Key → One-click install, 3 steps to complete',
    ...
    oneClickInstallDesc: '3 steps to complete, no configuration needed',
...
4. Bot will automatically receive AI assistant messages`,
  ...
  zh: {
    ...
    homeDescription: '选择用途 → 输入 API Key → 一键安装，3 步完成',
    oneClickDeploy: '一键部署',
    getStarted: '开始使用',
    ...
    oneClickInstallDesc: '3 步完成，无需配置',
