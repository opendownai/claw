...
export const translations: Record<Language, Translations> = {
  en: {
    discord: 'Discord',
    github: 'GitHub',
    homeTitle: 'OpenClaw Deploy',
    homeSubtitle: 'OpenDown ecosystem\'s personal AI assistant deployment tool',
    ...
    whyChooseDownclaw: 'Why use OpenDown\'s deployment tool?',
    dataLocalStorage: 'Local Deployment',
    dataLocalStorageDesc: 'Your data stays on your own computer with full privacy',
    oneClickInstall: 'One-Click Deployment',
    oneClickInstallDesc: 'Automated installation process, no technical background required',
    multiChannelAccess: 'Smart Configuration Wizard',
    multiChannelAccessDesc: 'Graphical channel setup, supports multiple platforms',
    ...
    step: 'Step',
    discordSupport: 'Xiaohongshu',
    faq: 'FAQ',
    faqNodeTitle: 'Q: Mac says I\'m not an administrator?',
    faqNodeAnswer: 'A: The installer requires admin privileges to install Homebrew and system tools. Please ensure you\'re logged in as an Administrator account (check System Settings → Users & Groups).',
    faqBrewTitle: 'Q: Installation seems stuck on Xcode Command Line Tools?',
    faqBrewAnswer: 'A: The installer is waiting for you to confirm the Xcode CLI tools popup. Check if there\'s a dialog box asking to install developer tools, click "Install" and wait for completion.',
    faqInstallFailedTitle: 'Q: After installation, \'openclaw\' command not found?',
    faqInstallFailedAnswer: 'A: Your shell PATH may not include Homebrew\'s bin directory. Restart your terminal, or add \'eval "$(/opt/homebrew/bin/brew shellenv)"\' to your ~/.zshrc file and restart the terminal.',
  ...
  zh: {
    discord: 'Discord',
    github: 'GitHub',
    homeTitle: 'OpenClaw 部署',
    homeSubtitle: 'OpenDown 生态的个人 AI 助手一键部署工具',
    homeDescription: '选择用途 → 选择渠道 → 配置API → 开始安装，4步完成',
    oneClickDeploy: '一键部署 OpenClaw',
    getStarted: '开始使用 OpenClaw',
    whyChooseDownclaw: '为什么使用 OpenDown 的部署工具？',
    dataLocalStorage: '本地化部署',
    dataLocalStorageDesc: '数据完全本地存储，隐私安全有保障',
    oneClickInstall: '一键部署',
    oneClickInstallDesc: '自动化安装流程，无需技术背景',
    multiChannelAccess: '智能配置向导',
    multiChannelAccessDesc: '图形化渠道配置，支持多平台接入',
    footerDownclaw: 'OpenClaw',
    footerLicense: 'MIT License',
    ...
    discordSupport: '小红书',
    faq: '常见问题',
    faqNodeTitle: 'Q: Mac 提示我不是管理员？',
    faqNodeAnswer: 'A: 安装脚本需要管理员权限来安装 Homebrew 和系统工具。请确保您使用的是管理员账户（在系统设置 → 用户与群组中确认）。',
    faqBrewTitle: 'Q: 安装卡在 Xcode Command Line Tools 了？',
    faqBrewAnswer: 'A: 安装脚本正在等待您确认 Xcode 命令行工具的弹窗。请检查是否有对话框询问是否安装开发者工具，点击"安装"并等待完成。',
    faqInstallFailedTitle: 'Q: 安装完成后找不到 \'openclaw\' 命令？',
    faqInstallFailedAnswer: 'A: 您的 shell PATH 可能没有包含 Homebrew 的 bin 目录。请重启终端，或者将 \'eval "$(/opt/homebrew/bin/brew shellenv)"\' 添加到您的 ~/.zshrc 文件中，然后重启终端。',
