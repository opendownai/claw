...
EOF`
  ...
  if (alreadyInstalled.value) {
    // For already installed: plugins, config, restart, browser
    installCommand = getPluginsModule() + getConfigModule() + getRestartModule() + getBrowserModule()
  } else {
    // For new install: install, plugins, config, restart, browser
    installCommand = getInstallModule() + getPluginsModule() + getConfigModule() + getRestartModule() + getBrowserModule()
  }
